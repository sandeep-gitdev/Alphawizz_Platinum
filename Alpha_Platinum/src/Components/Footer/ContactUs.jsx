      ...
      return(
         <>
          ...
          <div className="flex justify-center items-center gap-4  m-8">
               ...
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3679.335179746721!2d75.89112842477894!3d22.75293912936366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396302af403406fb%3A0x5b50834b117f8bab!2sVijay%20Nagar%2C%20Indore%2C%20Madhya%20Pradesh%20452010!5e0!3m2!1sen!2sin!4v1727351802610!5m2!1sen!2sin" width="700" height="550"   loading="lazy"></iframe> 
               </div>

               <div className="contact_us w-[40%] h-[40%] border-2 flex flex-col gap-5 justify-around p-10 box-border">
                         ...
                         <form className="flex gap-3 font-semibold">
                             ...
                             <label htmlFor="" className="font-medium">Vendor</label>
                             <input type="radio" name="" id="" />
                             <label htmlFor="" className="font-medium">Customer</label>
                         </form>
                         ...
                         <div className="">
                          <label htmlFor="">Message</label>
                           <textarea name="message" rows="4" cols="58" id="" className="border-2 w-[100%] px-4 outline-[#49A6A2]"></textarea>
                         </div>

                         <button className="bg-[#4aa6a3] p-3 w-[100%] text-lg text-white ">Send Message</button>
                  </div>
         </div>
         <div className="flex w-[80%] m-auto justify-center items-center gap-2 my-16">
                     <div className=" w-[100%] flex flex-col justify-center items-center py-8 px-3 border-2 rounded-md  relative">
