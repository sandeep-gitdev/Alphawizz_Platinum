         ...
         <>
                  <div className="heading  ">
                     <div className="content flex justify-between items-center bg-[#addadd] border-1 border-white h-20 p-10">
                          <h1 className="text-xl">{ProductData.category}</h1>
                         <div className="flex ">
                          <p>Home /</p>
                          <p>Category /</p>
                          <p>Products </p>
                   ...
                   <section>
                      <div className="maincontainer grid grid-cols-2  mx-52 my-10">
                            ...
                            //       ProductData.map((element,id) => {
                             ...
                             <div className="imgContent flex justify-center items-center w-[80%] h-[50%]"
                                   key={ProductData.id}>
                                      <div className="p-12">
                             <ReactImageMagnify {...{
                                                 smallImage: {
                             ...
                             <div className="contInfo  p-8 flex flex-col gap-3">
                                    <div className="">
                                        <h2 className="font-semibold text-lg mb-3">{ProductData.category}</h2>
                                         <p className="">{ProductData.title.trim().slice(0, 20)}</p>
                                    </div>
                                    <hr />
                                    <div className="flex  text-xl ">
                                      <span ><CiStar className="hover:bg-yellow-500"/></span>
                                      <span ><CiStar className="hover:bg-yellow-500"/></span>
                                      <span ><CiStar className="hover:bg-yellow-500"/></span>
                                      <span ><CiStar className="hover:bg-yellow-500"/></span>
                                      <span ><CiStar className="hover:bg-yellow-500"/></span>
                                    ...
                                    <div className="price ">
                                         ...
                                         <input type="text" placeholder="Zipcode" className="border-2 mr-4 p-2 w-48"/>
                                         <button className="border-2 p-2 rounded-md border-[#49A6A2] text-[#49A6A2]">Check Availablitiy</button>
                                    </div>
                                    <div className=" border-2 w-28 flex justify-around mt-5 p-2">
                                        <button onClick={() => dec(1)}>-</button> <span>{num}</span> <button onClick={() => inc(1)}>+</button>
                                    </div>
                                      <div className="">
                                    <button className="mr-3 border-2 border-[#49A6A2] rounded-md p-3 text-[#49A6A2]">Add to cart</button>
                                    <button className="mr-3 border-2 border-red-700 rounded-md p-3 text-red-700">Add to Favorite</button>
                                    </div>
                                    <p>Seller <span className="text-sky-700">Raj Babbar</span></p>
                             </div>
                                           </>
